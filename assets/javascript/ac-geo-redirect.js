...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers */ "./src/javascript/helpers.js");
...
jQuery(function ($) {
  ...
  function _showPopup() {
    _showPopup = _asyncToGenerator(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var _AcGeoRedirect, currentBlogData, siteMap, defaultT10ns, APIURL, redirectLocale, redirectBlogData, foundDomain, region;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _AcGeoRedirect = AcGeoRedirect, currentBlogData = _AcGeoRedirect.currentBlogData, siteMap = _AcGeoRedirect.siteMap, defaultT10ns = _AcGeoRedirect.defaultT10ns, APIURL = _AcGeoRedirect.APIURL;
              _context.next = 3;
              return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getCountryCode"])(APIURL);

            case 3:
              redirectLocale = _context.sent;
              ...
              console.error('AcGeoRedirect.redirectLocale not set. (See Plugin.php).', 'Did you add the debug header (x-ac-debug-country-code) or are the headers setup correctly for NGINX or cloudflare?', 'See the readme for more info');
              return _context.abrupt("return");

            case 7:
              redirectBlogData = null;
            ...
            case 10:
              ...
              if (siteMap.hasOwnProperty(redirectLocale)) {
                ...
                redirectBlogData = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getDefaultBlogData"])(AcGeoRedirect);
              }
            ...
            case 14:
              if (foundDomain) {
                ...
                region = Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["getCountryNameFromCode"])(redirectLocale);
              ...
              console.warn("Unable to find country name for country code: ".concat(redirectLocale));
              return _context.abrupt("return");

            case 18:
              if ('United States' === region || 'United Kingdom' === region) {
                region = "the ".concat(region);
              }

              render({
                redirectBlogData: redirectBlogData,
  ...
  function render(_ref) {
    var redirectBlogData = _ref.redirectBlogData,
        currentBlogData = _ref.currentBlogData,
        _ref$region = _ref.region,
        region = _ref$region === void 0 ? '' : _ref$region;
    var $popup = $('#ac-geo-popup');
    var $body = $('body');
    ...
    $('.ac-geo-popup-redirect-link').attr('href', "".concat(redirectBlogData.url, "?no_geo_redirect=1"));
  ...
  function init() {
    if (!Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["localStorageExists"])()) {
      return;
    }
...
/*!***********************************!*\
  !*** ./src/javascript/helpers.js ***!
  \***********************************/
/*! exports provided: getCountryNameFromCode, localStorageExists, getCountryCode, getDefaultBlogData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCountryNameFromCode", function() { return getCountryNameFromCode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "localStorageExists", function() { return localStorageExists; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCountryCode", function() { return getCountryCode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDefaultBlogData", function() { return getDefaultBlogData; });
/* harmony import */ var _countries__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./countries */ "./src/javascript/countries.js");
...
function getCountryCode(APIURL) {
  return new Promise(function (resolve, reject) {
    jQuery.post("".concat(APIURL, "/get-country-code")).then(function (_ref) {
      var code = _ref.code;
      return resolve(code);
    }).fail(function (something) {
      return reject(something);
    });
  });
}
function getDefaultBlogData(_ref2) {
  var siteMap = _ref2.siteMap,
      defaultSiteId = _ref2.defaultSiteId,
      defaultLocale = _ref2.defaultLocale;

  if (defaultSiteId) {
    var site = Object.values(siteMap).find(function (_ref3) {
      var id = _ref3.id;
...
/***/ 0:
/*!*********************************************************!*\
  !*** multi ./src/javascript/app.js ./src/scss/app.scss ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /www/earin.com.dev.synot.io/site/public/wp-content/plugins/ac-geo-redirect/src/javascript/app.js */"./src/javascript/app.js");
module.exports = __webpack_require__(/*! /www/earin.com.dev.synot.io/site/public/wp-content/plugins/ac-geo-redirect/src/scss/app.scss */"./src/scss/app.scss");
